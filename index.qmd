...
There are 2 datasets included in this analysis. The first is historical data during the past 120 years history of the olympic (1896-2016). The second dataset is the dataset for 2021 Tokyo Olympics. This analysis includes athletes, genders, coaches, and number of medals by countries.
...
geom_point(shape=21,size=3.5,colour="darkgray")+
  geom_text(color="black", size=3, hjust=-0.2,vjust = -0.5,
          aes(x=n, label=n))+
